...
pizzaImg.src = '/assets/images/cheeseburger_pizza.png';
pizzaImg.alt = 'pizza';
pizza.append(pizzaImg);

let namePizza = document.createElement('h3');
pizzaImg.after(namePizza);
namePizza.innerHTML = 'Чизбургер-пицца';

let pizzaOptions = document.createElement('div');
...
thinDough.htmlFor = 'radio-dough-1';
...
traditionalPizza.id = 'radio-dough-2';
...
traditionalDough.htmlFor = 'radio-dough-2';
